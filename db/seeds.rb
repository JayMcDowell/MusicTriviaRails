...
sixties_questions = [
  [ 'easy', 'Which holiday favorite has these lines: "My mother will start to worry", "My father will be pacing the floor"?', 'Frosty The Snowman', 'Baby, It\'s Cold Outside', 'The Christmas Song', 'Ill Be Home For Christmas', 'Baby, It\'s Cold Outside' ],
  [ 'easy', 'What number 1 song from 1963 had these lyrics: "Judy and Johnny just walked through the door; Like a queen with her king"?', 'Hes So Fine', 'Walk Like A Man', 'Our Day Will Come', 'It\'s My Party', 'It\'s My Party' ],
  ...
  [ 'easy', 'What top ten hit by Jan and Dean has the lyrics "Well, the last thing I remember, Doc, I started to swerve; And then I saw the Jag slide into the curve"?', 'Jennie Lee', 'Drag City', 'Baby Talk', 'Dead Man\'s Curve', 'Dead Man\'s Curve' ],
  ...
  [ 'easy', 'What Rolling Stones\' song has the line: "But it\'s all right now; in fact, it\'s a gas"?', 'Sugar Sugar', 'What\'s Going On', 'Wedding Bell Blues', 'Jumpin Jack Flash', 'Jumpin Jack Flash' ],
  ...
  [ 'easy', 'Who had a hit song in 1967 with these lyrics: "I think we\'re alone now; There doesnt seem to be anyone around"?', 'Johnny Rivers', 'Sam & Dave', 'The Box Tops', 'Tommy James & The Shondells', 'Tommy James & The Shondells' ],
  ...
  [ 'easy', 'What Supremes hit was covered by Phil Collins in the 1980s?', 'Someday Well Be Together', 'You Keep Me Hangin On', 'Love Child', 'You Can\'t Hurry Love', 'You Can\'t Hurry Love' ],
  ...
  [ 'easy', 'What Elvis Presley hit had these lyrics: "I gave a letter to the postman, he put it his sack; Bright and early next morning, he brought my letter back"?', 'It\'s Now Or Never', 'Are You Lonesome Tonight?', 'Return To Sender', 'Can\'t Help Falling In Love', 'Return To Sender' ],
  [ 'easy', 'Finish this line from Steppenwolf\'s "Magic Carpet Ride": "Why don\'t you tell your dreams to me; Fantasy will ____"?', 'Lewis Lea', 'set you free', 'help you see', 'let me be', 'set you free' ],
  [ 'easy', 'Finish the lyrics from a hit song by The Angels: "....and you\'re gonna be in trouble, hey la day da...."?', 'I Adore Him', 'My Boyfriends Back', 'Cry Baby Cry', 'Wow Wow Wee (Hes The Boy For Me)', 'My Boyfriends Back' ],
  ...
  [ 'easy', 'What 1961 hit opens with the lyrics "I couldn\'t sleep at all last night"?', 'Tossin\' And Turnin\'', 'Wonderland By Night', 'Crying', 'Please Mr. Postman', 'Tossin\' And Turnin\'' ],
  ...
  [ 'easy', 'What number 1 song from 1962 had these lines: "My little baby sister can do it with ease; It\'s easier than learning your A-B-Cs"?', 'Twist & Shout', 'The Loco-Motion', 'Big Girls Don\'t Cry', 'The Twist', 'The Loco-Motion' ],
  ...
  [ 'easy', 'Which Supremes hit was about having a child out of wedlock?', 'Everybody\'s Got The Right To Love', 'Im Livin In Shame', 'Reflections', 'Love Child', 'Love Child' ],
  ...
  [ 'hard', 'What 1967 hit begins with "There\'s something happening here, what it is ain\'t exactly clear"?', 'Turn, Turn, Turn', 'Happy Together', 'Suite Judy Blue Eyes', 'For What It\'s Worth', 'For What It\'s Worth' ],
  ...
  [ 'hard', 'Who sang the lines "Rape! Murder! It\'s just a shot away, it\'s just a shot away!" in The Rolling Stones\' "Gimme Shelter"?', 'Shah Jalal', 'Gordon Lightfoot', 'Sammy Davis, Jr.', 'Merry Clayton', 'Merry Clayton' ],
  ...
  [ 'hard', 'What artist was the founder and leader of James Brown\'s vocal group The Famous Flames?', 'Steve Cunningham', 'Johnny Bennett', 'Jimmy Reed', 'Bobby Byrd', 'Bobby Byrd' ],
  ...
  [ 'hard', 'What 1966 hit has these lyrics: "I can tell the way you hang your head that you\'re alone now, you\'re afraid"', 'Reach Out Ill Be There', 'Cherish', 'Hanky Panky', 'Good Lovin', 'Reach Out Ill Be There' ],
  ...
  [ 'hard', 'What group\'s lineup consisted of former singers from The Serendipity Singers and The Pixies Three?', 'The Angels', 'The Chi-Lites', 'The Raindrops', 'The Dells', 'The Angels' ],
  ...
  [ 'hard', 'Which "Easy Rider" star was supposedly the subject of John Lennon\'s 1966 song "She Said She Said"?', 'Paul Newman', 'Peter Fonda', 'Sean Connery', 'James Dean', 'Peter Fonda' ],
  ...
  [ 'hard', 'Which guitarist played on Tom Jones "It\'s Not Unusual"?', 'Keith Richards', 'Eric Clapton', 'Jimi Hendrix', 'Jimmy Page', 'Jimmy Page' ],
  ...
  [ 'hard', 'What 1960s song by Simon & Garfunkel (and also Harper\'s Bizarre) starts "Slow down, you move to fast, you got to make the morning last"?', 'I Am A Rock', '59th Street Bridge Song', 'Homeward Bound', 'Cecillia', '59th Street Bridge Song' ],
  ...
  [ 'hard', 'Which Nancy Sinatra song was sampled in Robbie William\'s hit "Millenium"?', 'These Boots Are Made For Walkin', 'Sugar Town', 'You Only Live Twice', 'Somethin Stupid', 'You Only Live Twice' ],
  [ 'hard', 'In what year did Chubby Checker\'s song "The Twist" hit number 1 for the second time?', '1962', '1966', '1968', '1964', '1962' ],
  ...
  [ 'hard', 'What Dion hit has these lyrics: "Here\'s the moral and the story from the guy who knows, I fell in love and my love still grows"?', 'Abraham, Martin & John', 'Im A Fool', 'Runaround Sue', 'Little Diane', 'Runaround Sue' ],
  ...
  [ 'hard', 'What band did Chester Thompson play drums for in the 1960s and 1970s?', 'Genesis', 'The Rolling Stones', 'Yes', 'Rush', 'Genesis' ],
  ...
  [ 'hard', 'Which Crosby, Stills, Nash and Young song begins with the lyrics "It\'s getting to the point where I\'m no fun anymore"?', 'Marrakesh Express', 'Carry On', 'Just A Song Before I Go', 'Suite Judy Blue Eyes', 'Suite Judy Blue Eyes' ],
...
seventies_questions = [
  [ 'easy', 'What American city\'s freedom did Elton John salute in 1975?', 'New York', 'Boston', 'Philadelphia', 'New Orleans', 'Philadelphia' ],
  ...
  [ 'easy', 'What was the name of Barbra Streisand and Neil Diamond\'s 1978 duet?', 'I Finally Found Someone', 'No More Tears', 'You Don\'t Bring Me Flowers', 'What Kind Of Fool', 'You Don\'t Bring Me Flowers' ],
  [ 'easy', 'On what soundtrack did Yvonne Elliman\'s hit "If I Can\'t Have You" appear?', 'Grease', 'Rocky', 'Animal House', 'Saturday Night Fever', 'Saturday Night Fever' ],
  ...
  [ 'easy', 'For what song did Isaac Hayes win an Academy Award for Best Original Song?', 'Walk On By', 'Theme From Shaft', 'Do Your Thing', 'Don\'t Let Go', 'Theme From Shaft' ],
  [ 'easy', 'Who adopted a stage persona named Ziggy Stardust?', 'John Lennon', 'Elton John', 'David Bowie', 'Brogan Sykes', 'David Bowie' ],
  [ 'easy', 'What Aerosmith hit had these lines: "I was a high school loser never made it with a lady; Till the boys told me somethin I missed"', 'Rag Doll', 'Walk This Way', 'Dream On', 'I Don\'t Wanna Miss A Thing', 'Walk This Way' ],
  [ 'easy', 'What two words finish this line from Shocking Blue\'s hit "Venus": "A goddess on a mountain top was burning like a _________"?', 'wild heart', 'smoking gun', 'silver flame', 'fire hot', 'silver flame' ],
  [ 'easy', 'What Barbra Streisand hit was the theme to her own 1973 movie that she co-starred with Robert Redford?', 'You Don\'t Bring Me Flowers', 'Evergreen', 'The Way We Were', 'Eyes Of Laura Mars', 'The Way We Were' ],
  [ 'easy', 'Which Queen song had these lyrics: "Mama just killed a man. Put a gun against his head. Pulled my trigger, now he\'s dead"?', 'Another One Bites The Dust', 'Bohemian Rhapsody', 'Under Pressure', 'We Will Rock You', 'Bohemian Rhapsody' ],
  ...
  [ 'easy', 'What group\'s original members included Brian, John, Freddie and Roger?', 'Fleetwood Mac', 'Doobie Brothers', 'Queen', 'Toto', 'Queen' ],
  ...
  [ 'easy', 'Who was England Dan\'s partner on several chart hits?', 'John Ford Coley', 'Philip Bailey', 'Lou Rawls', 'Michelle Hey', 'John Ford Coley' ],
  [ 'easy', 'Who was Ringo Starr\'s backing band?', 'The Starrs', 'The Ringos', 'All-Starr Band', 'The Starr-fish', 'All-Starr Band' ],
  ...
  [ 'easy', 'What Police song includes these lyrics? "A year has passed since I wrote my note, but I should have known this right from the start. Only hope can keep me together?', 'Wrapped Around My Finger', 'Don\'t Stand So Close To Me', 'Message In A Bottle', 'Roxanne', 'Message In A Bottle' ],
  ...
  [ 'easy', 'What group\'s original members included Roger, Howard, Steve, Michael, Ann and Nancy?', 'Heart', 'Fleetwood Mac', 'The Mamas and The Papas', 'Sugarland', 'Heart' ],
  ...
  [ 'easy', 'Which actor\'s first music hit was "Let Her In" in 1976?', 'Dan Aykroyd', 'Bruce Willis', 'John Travolta', 'Mark Wahlberg', 'John Travolta' ],
  ...
  [ 'easy', 'What song was originally recorded by Harold Melvin & The Bluenotes, but was taken to number 1 by Thelma Houston in 1977?', 'I Will Survive', 'Don\'t Leave Me This Way', 'If It\'s The Last Thing I Do', 'Save The Country', 'Don\'t Leave Me This Way' ],
  ...
  [ 'easy', 'What 1979 Rod Stewart song was very different from his earlier material because of it\'s disco elements?', 'This Old Heart Of Mine', 'Do Ya Think Im Sexy?', 'You Wear It Well', 'Love Touch', 'Do Ya Think Im Sexy?' ],
  [ 'easy', 'What Carole King song won a Grammy Award for Record Of The Year in 1972?', 'One Fine Day', 'It\'s Too Late', 'Sweet Seasons', 'Jazzman', 'It\'s Too Late' ],
  ...
  [ 'easy', 'What group\'s original members included Michael, Eddie, Alex, and David Lee?', 'Led Zeppelin', 'Van Halen', 'The Cars', 'Boston', 'Van Halen' ],
  ...
  [ 'easy', 'Elton John\'s original version of “Candle In The Wind” was about what actress?', 'Betty Davis', 'Gretty Garbo', 'Grace Kelly', 'Marilyn Monroe', 'Marilyn Monroe' ],
  ...
  [ 'easy', 'What actress is the daughter of Aerosmith\'s lead singer?', 'Kirsten Dunst', 'Elizabeth Banks', 'Liv Tyler', 'Gwyneth Paltrow', 'Liv Tyler' ],
  ...
  [ 'easy', 'What John Denver song was written for his wife?', 'Calypso', 'I Want To Live', 'Annie\'s Song', 'Thank God I\'m A Country Boy', 'Annie\'s Song' ],
  ...
  [ 'hard', 'Which group had a disco hit with these lyrics: "Cause rain, shine, won\'t mind; We\'re ridin on the groove line tonight"', 'KC & The Sunshine Band', 'Chic', 'The Trammps', 'Heatwave', 'Heatwave' ],
  ...
  [ 'hard', 'What album contained Elton John\'s original version of "Candle In The Wind"?', 'Goodbye Yellow Brick Road', 'Captain Fantastic And The Brown Dirt Cowboy', 'Too Low For Zero', '21 At 33', 'Goodbye Yellow Brick Road' ],
  ...
  [ 'hard', 'Which Blackbyrd\'s song has these lyrics: "It\'s been so long since I seen her; I\'m tired and so all alone"', 'Walking In Rhythm', 'Do It, Fluid', 'Flyin High', 'Happy Music', 'Walking In Rhythm' ],
  ...
  [ 'hard', 'Who wrote "Emotion," a hit song for Samantha Sang in 1977 and Destiny\'s Child in 2001?', 'Barry Manilow', 'The Bee Gees', 'Jeffrey Osborne', 'Dion', 'The Bee Gees' ],
  ...
  [ 'hard', 'What artist used the pseudonymn "Dr. Winston O Boogie" on Elton John\'s version of "Lucy In The Sky With Diamonds"?', 'Eric Clapton', 'Paul McCartney', 'John Lennon', 'Mick Jagger', 'John Lennon' ],
  [ 'hard', 'Which holiday song was performed by The Ramones?', 'Santa Claus And His Old Lady', 'Christmas At Ground Zero', 'Father Christmas', 'Merry Christmas (I Don\'t Want To Fight Tonight)', 'Merry Christmas (I Don\'t Want To Fight Tonight)' ],
  ...
  [ 'hard', 'What was James Taylor\'s first top 10 chart hit?', 'How Sweet It Is (To Be Loved By You)', 'Handy Man', 'You\'ve Got A Friend', 'Fire And Rain', 'Fire And Rain' ],
  ...
  [ 'hard', 'In which song does Freddie Mercury say "I work hard every day of my life, I work till I ache my bones" ?', 'Crazy Little Thing Called Love', 'Somebody To Love', 'Don\'t Stop Me Now', 'Bohemian Rhapsody', 'Somebody To Love' ],
  ...
  [ 'hard', 'What Elton John hit had these lyrics: "I can\'t find, oh the right romantic line; But see me once and see the way I feel"', 'Don\'t Let The Sun Go Down On Me', 'Daniel', 'Levon', 'Rocket Man', 'Don\'t Let The Sun Go Down On Me' ],
  ...
  [ 'hard', 'What "Doctor\'s Orders" singer was the cousin of Sam Cooke?', 'Kiki Dee', 'Chaka Khan', 'Carol Douglas', 'Diana Ross', 'Carol Douglas' ],
  [ 'hard', 'In "Won\'t Get Fooled Again," The Who said they would tip their hat to the new ____ (fill in the blank)', 'man up top', 'reformation', 'music on the radio', 'constitution', 'constitution' ],
  ...
  [ 'hard', 'What 1972 Rick Nelson song had these lyrics: "But if memories were all I sang I\'d rather drive a truck"', 'Never Be Anyone Else But You', 'Teenage Idol', 'Garden Party', 'Tricky', 'Garden Party' ],
  ...
  [ 'hard', 'Who wrote Manfred Mann\'s Earth Band\'s hit "Blinded By The Light"?', 'Olivia Newton-John', 'Brandon Lyons', 'John Lennon', 'Bruce Springsteen', 'Bruce Springsteen' ],
  [ 'hard', 'Who was the lead singer of Blondie?', 'Laura Meyerhoff', 'Debbie Harry', 'Bonnie Tyler', 'Belinda Carlisle', 'Debbie Harry' ],
  [ 'hard', 'What singer had hits in the 1970s titled "Me And You And A Dog Named Boo", "She Didn\'t Do Magic", and "Don\'t Expect Me To Be Your Friend" ?', 'Lobo', 'Gilbert O Sullivan', 'Randy Meisner', 'Norman Greenbaum', 'Lobo' ],
  [ 'hard', 'In Elton John\'s "Levon", what did Levon name his son?', 'Patch', 'Levon', 'Jesus', 'Elton', 'Jesus' ],
  ...
  [ 'hard', 'Who composed the score for TV\'s "Chico & The Man"?', 'Norman Greenbaum', 'Quincy Jones', 'Santana', 'Jose Feliciano', 'Jose Feliciano' ],
  ...
  [ 'hard', 'Who sang with Elton John in his original version of "Don\'t Go Breaking My Heart"?', 'Patti Austin', 'Kiki Dee', 'Marilyn Martin', 'Maria Muldaur', 'Kiki Dee' ],
  [ 'hard', 'Which ABBA hit has these lyrics: "Though I never thought that we could lose, There\'s no regret. If I had to do the same again, I would, my friend"', 'Waterloo', 'Fernando', 'Take A Chance On Me', 'Chiquitita', 'Fernando' ],
  [ 'hard', 'Which Beatle produced Badfinger\'s 1972 hit "Day After Day"?', 'John Lennon', 'Paul McCartney', 'George Harrison', 'Ringo Starr', 'George Harrison' ]
    ]
...
eighties_questions = [
  ...
  [ 'easy', 'What group\'s original members included Ralph, Michael, Ronald, Ricky and Bobby?', 'New Kids On The Block', 'Backstreet Boys', 'N Sync', 'New Edition', 'New Edition' ],
  [ 'easy', 'What 1987 Janet Jackson hit is generally interpreted as being about abstinence?', 'Any Time, Any Place', 'Let\'s Wait Awhile', 'Escapade', 'When I Think Of You', 'Let\'s Wait Awhile' ],
  [ 'easy', 'Who is the lead singer of Depeche Mode?', 'Dave Gahan', 'Vince Clarke', 'Andy Bell', 'Andy Fletcher', 'Dave Gahan' ],
  [ 'easy', 'What one-word title was a hit for both Kenny Rogers and Styx? (different versions)', 'Lady', 'Easy', 'Truly', 'Babe', 'Lady' ],
  [ 'easy', 'According to Tommy Tutone, what was Jenny\'s number?', '999-5123', '555-2525', 'Unlisted', '867-5309', '867-5309' ],
  [ 'easy', 'What is the name of Tom Petty\'s backing band?', 'The Heartbreakers', 'The E-Street Band', 'The Blackhearts', 'The Pistols', 'The Heartbreakers' ],
  [ 'easy', 'Who was Paul McCartney\'s duet partner in the hit "The Girl Is Mine"?', 'Smokey Robinson', 'Stevie Wonder', 'Luther Vandross', 'Michael Jackson', 'Michael Jackson' ],
  ...
  [ 'easy', 'Which holiday favorite has these lines: "My mother will start to worry", "My father will be pacing the floor"?', 'Frosty The Snowman', 'Baby, It\'s Cold Outside', 'I\'ll Be Home For Christmas', 'The Christmas Song', 'Baby, It\'s Cold Outside' ],
  ...
  [ 'easy', 'In 1986, Robert Palmer said "You might as well face it you\'re ___" (fill in the blank)?', 'Falling Too Fast', 'Crazy Like Me', 'Coming On Home', 'Addicted To Love', 'Addicted To Love' ],
  ...
  [ 'easy', 'From what 1986 movie did "Take My Breath Away" win a Best Original Song Academy Award?', 'That\'s Life!', 'Back To The Future', 'Top Gun', 'Beverly Hills Cop', 'Top Gun' ],
  ...
  [ 'easy', '"Buying bread from a man in Brussels. He was six foot four and full of muscles." are lines from what Men At Work hit?', 'Overkill', 'Down Under', 'It\'s A Mistake', 'Who Can It Be Now', 'Down Under' ],
  ...
  [ 'easy', 'What speed limit did Sammy Hagar say he couldn\'t drive?', '30', '75', '55', '65', '55' ],
  ...
  [ 'easy', 'In 1988, the Pet Shop Boys had a hit with a remake of what Elvis Presley song?', 'Suspicious Minds', 'West End Girls', 'Always On My Mind', 'Don\'t Be Cruel', 'Always On My Mind' ],
  ...
  [ 'easy', 'Rihannas "Don\'t Stop The Music" borrowed the line "mama-se, mama-sa, ma-ma-koo-sa" from which Michael Jackson song?', 'Wanna Be Startin Somethin', 'Don\'t Stop Til You Get Enough', 'Bad', 'Smooth Criminal', 'Wanna Be Startin Somethin' ],
  ...
  [ 'hard', 'What was the hit collaboration featuring Ozzy Osborne and Lita Ford?', 'Shot In The Dark', 'Close My Eyes Forever', 'I Don\'t Wanna Stop', 'Mama, Im Coming Home', 'Close My Eyes Forever' ],
  ...
  [ 'hard', 'Which of these Michael Jackson songs were not written by himself?', 'Man In The Mirror', 'They Don\'t Care About Us', 'Billie Jean', 'Beat It', 'Man In The Mirror' ],
  [ 'hard', 'What band released the album "Dare" in 1982?', 'Roxy Music', 'Depeche Mode', 'Erasure', 'The Human League', 'The Human League' ],
  [ 'hard', 'Bette Midler\'s "Wind Beneath My Wings" was on what 1989 soundtrack?', 'The Little Mermaid', 'Dead Poets Society', 'Batman', 'Beaches', 'Beaches' ],
  ...
  [ 'hard', 'What is artist Dino\'s last name?', 'Copas', 'Wilson', 'Maestro', 'Esposito', 'Esposito' ],
  ...
  [ 'hard', 'What 1980s hit song begins with "Dark in the city, night is a wire, Steam in the subway, earth is afire"?', 'Don\'t You Want Me', 'Hungry Like The Wolf', 'West End Girls', 'Eye Of The Tiger', 'Hungry Like The Wolf' ],
  [ 'hard', 'Which Bon Jovi hit had these lyrics: "I know you know we\'ve had some good times, Now they have their own hiding place"?', 'I\'ll Be There For You', 'Always', 'You Give Love A Bad Name', 'Lay Your Hands On Me', 'I\'ll Be There For You' ],
  ...
  [ 'hard', 'What is singer Pat Benatar\'s real name?', 'Louise Ciccone', 'Cheryl Gentry', 'Dawn Andrade', 'Patricia Andrejewski', 'Patricia Andrejewski' ],
  [ 'hard', 'Who sang the theme song to "Pee Wee\'s Playhouse"?', 'Cyndi Lauper', 'Kim Carnes', 'Terri Nunn', 'Belinda Carlisle', 'Cyndi Lauper' ],
  ...
  [ 'hard', 'Who produced Kajagoogoo\'s first album?', 'Duran Duran\'s Nick Rhodes', 'Prince', 'Sting', 'Simply Reds Mick Hucknall', 'Duran Duran\'s Nick Rhodes' ],
  ...
  [ 'hard', 'In what year did "Arthur\'s Theme (The Best That You Can Do)" win a Best Original Song Academy Award?', '1989', '1981', '1987', '1984', '1981' ],
  ...
  [ 'hard', 'What film was Phil Collins and Marilyn Martin\'s "Separate Lives" from?', 'Mr. Mom', 'White Nights', 'Flashdance', 'Tootsie', 'White Nights' ],
  ...
  [ 'hard', 'Who was the original choice to sing Blondie\'s hit "Call Me"?', 'Diana Ross', 'Laura Branigan', 'Linda Ronstadt', 'Stevie Nicks', 'Stevie Nicks' ],
  ...
  [ 'hard', 'What song the Kinks marked their return to the top ten on the Billboard Hot 100 in 1983?', 'Come Dancing', 'Lola', 'I\'m Going Home', 'You Really Got Me', 'Come Dancing' ],
  ...
  [ 'hard', 'Who directed Belinda Carlisle\'s "Heaven Is A Place On Earth" video?', 'George Lucas', 'Cher', 'Steven Spielberg', 'Diane Keaton', 'Diane Keaton' ],
  ...
  [ 'hard', 'In what year did KC & The Sunshine Band have a number 1 hit with "Please Don\'t Go"?', '1980', '1986', '1989', '1983', '1980' ],
  [ 'hard', 'Who wrote the 1984 Diana Ross hit "Missing You"?', 'Desmond Cain', 'Smokey Robinson', 'Lionel Richie', 'Michael Jackson', 'Lionel Richie' ],
  [ 'hard', 'What is singer Huey Lewis\' real name?', 'Stanley Burrell', 'Hugh Cregg III', 'Marvin Lee Aday', 'Paul Harvey', 'Hugh Cregg III' ],
  [ 'hard', 'What story was the inspiration for Tom Petty\'s video for "Don\'t Come Around Here No More"?', 'Alice In Wonderland', 'Gullivers Travels', 'Treasure Island', 'Snow White & The Seven Dwarves', 'Alice In Wonderland' ],
  [ 'hard', 'What is singer George Michael\'s real name?', 'Faroukh Bulsara', 'Georgios Panayiotou', 'Chaim Witz', 'William Bailey', 'Georgios Panayiotou' ],
  ...
  [ 'hard', 'What duo wrote Whitney Houston\'s "How Will I Know" and "I Wanna Dance With Somebody"?', 'Wham!', 'Boy Meets Girl', 'Tin Tin', 'Eurythmics', 'Boy Meets Girl' ],
  [ 'hard', 'What Missing Persons guitarist joined Duran Duran\'s lineup in 1990?', 'Robert Palmer', 'Andy Rhodes', 'Warren Cuccurullo', 'Vince Clarke', 'Warren Cuccurullo' ],
  [ 'hard', 'The Stone Roses "Fool\'s Gold" is built around a song loop from which artist?', 'Ray Charles', 'James Brown', 'Michael Jackson', 'Stevie Wonder', 'James Brown' ],
  [ 'hard', 'Heaven 17\'s Ian Craig Marsh and Martyn Ware were originally in which band?', 'Thompson Twins', 'Depeche Mode', 'Camouflage', 'Human League', 'Human League' ],
  ...
  [ 'hard', 'David Bowie\'s 1983 hit song "Lets Dance" featured what guitarist?', 'Stevie Ray Vaughan', 'Jimmy Page', 'Eddie Van Halen', 'Eric Clapton', 'Stevie Ray Vaughan' ],
  ...
  [ 'hard', 'What is Elvis Costello\'s real name?', 'Raymond Ayala', 'Christopher Davidson', 'Aldo Sigismondi', 'Declan MacManus', 'Declan MacManus' ],
  ...
  [ 'hard', 'What was the name of Weird Al Yankovic\'s parody of Toni Basil\'s "Mickey"?', 'Hicky', 'Sticky', 'Licky', 'Ricky', 'Ricky' ],
  [ 'hard', 'For what song did Graham Lyle & Terry Britten win a Song of the Year (songwriting) Grammy Award in 1985?', 'Time After Time', 'What\'s Love Got To Do With It', 'I Just Called To Say I Love You', 'Against All Odds (Take A Look At Me Now)', 'What\'s Love Got To Do With It' ],
  ...
  [ 'hard', 'What was the first song to hit number 1 by Madonna?', 'Vogue', 'Papa Don\'t Preach', 'Like A Virgin', 'Like A Prayer', 'Like A Virgin' ],
  [ 'hard', 'In which Tina Turner hit does she sing “Deutschmarks or dollars, American Express will do nicely, thank you”?', 'Typical Male', 'Private Dancer', 'What\'s Love Got To Do With It', 'The Best', 'Private Dancer' ],
  ...
  [ 'hard', 'What is U2 member Bono\'s real name?', 'Paul Hewson', 'William Bailey', 'Dave Evans', 'Chris Reid', 'Paul Hewson' ],
  ...
  [ 'hard', 'What singer played Buddy Holly in the 1987 movie "La Bamba"?', 'Lou Diamond Philips', 'Marshall Crenshaw', 'Christopher Fryman', 'Jon Bon Jovi', 'Marshall Crenshaw' ],
  ...
  [ 'hard', 'What popular 1980s song had these lyrics: "I\'m just an average man with an average life. I work from nine to five, hey hey, I\'ll pay the price"?', 'Somebodys Watching Me', 'Come On Eileen', 'Always Something There To Remind Me', 'Tainted Love', 'Somebodys Watching Me' ],
  [ 'hard', 'What group sang the background vocals on Cyndi Lauper\'s hit "Change Of Heart"?', 'Go-Gos', 'The Bangles', 'Pointer Sisters', 'The Waitresses', 'The Bangles' ],
  ...
  [ 'hard', 'In what year did Dionne (Warwick) & Friends have a number 1 hit with "That\'s What Friends Are For"?', '1989', '1980', '1986', '1983', '1986' ]
    ]
...
nineties_questions = [
  ...
  [ 'easy', 'Who had a song called "It\'s Good To Be King" from his "Wildflowers" album?', 'Tom Petty', 'Richard Marx', 'Paul McCartney', 'Robert Palmer', 'Tom Petty' ],
  [ 'easy', 'Who had a hit in 1993 with "Please Forgive Me"?', 'Peabo Bryson', 'Bryan Adams', 'Billy Joel', 'George Harrison', 'Bryan Adams' ],
  [ 'easy', 'What was the name of the Aerosmith song featured in the Bruce Willis movie "Armageddon"?', 'I Don\'t Want To Miss A Thing', 'Fly Away From Here', 'Livin On The Edge', 'Dream On', 'I Don\'t Want To Miss A Thing' ],
  ...
  [ 'easy', 'Who was Lisa Loeb\'s backing band?', 'The Blackhearts', 'The New Bohemians', 'Nine Stories', 'The Ladies', 'Nine Stories' ],
  ...
  [ 'easy', 'In which Celine Dion hit does she sing "Cause I am your lady, And you are my man" ?', 'A New Day Has Come', 'It\'s All Coming Back To Me Now', 'The Power Of Love', 'That\'s The Way It Is', 'The Power Of Love' ],
  ...
  [ 'easy', 'Who sang the 1998 hit song "I Don\'t Want To Miss A Thing"?', 'Def Leppard', 'Savage Garden', 'Aerosmith', 'Fastball', 'Aerosmith' ],
  [ 'easy', 'What was Aqua\'s biggest chart hit?', 'Space Invaders', 'Cartoon Heroes', 'Barbie Girl', 'Turn Back Time', 'Barbie Girl' ],
  ...
  [ 'easy', 'What group had the hit songs "Beautiful Life" and "Don\'t Turn Around"?', 'Elastica', 'TLC', 'Better Than Ezra', 'Ace Of Base', 'Ace Of Base' ],
  ...
  [ 'easy', 'For what song did Eric Clapton win a Song of the Year (songwriting) Grammy Award in 1993?', 'My Fathers Eyes', 'Layla', 'I Can\'t Stand It', 'Tears In Heaven', 'Tears In Heaven' ],
  [ 'easy', 'Which country singer\'s name did the Barenaked Ladies mention in their hit "One Week"?', 'Shania Twain', 'Faith Hill', 'LeAnn Rimes', 'Trisha Yearwood', 'LeAnn Rimes' ],
  ...
  [ 'easy', 'What Madonna hit song was a tribute to movie stars of the past?', 'Vogue', 'Dress You Up', 'American Life', 'Who\'s That Girl', 'Vogue' ],
  ...
  [ 'easy', 'What rock group\'s members include brothers Angus and Malcolm Young?', 'Brother To Brother', 'AC/DC', 'Rhythm Heritage', 'The Beach Boys', 'AC/DC' ],
  ...
  [ 'easy', 'Which Hootie & the Blowfish hit has the lyrics "I\'m such a baby, cause dolphins make me cry."', 'Hold My Hand', 'Time', 'Only Wanna Be With You', 'Tuckers Town', 'Only Wanna Be With You' ],
  [ 'easy', 'What Celine Dion song won a Record Of The Year Grammy Award in 1999?', 'You\'re Still The One', 'Taking Chances', 'My Heart Will Go On', 'Where Does My Heart Beat Now', 'My Heart Will Go On' ],
  ...
  [ 'easy', 'What band had hits with "It\'s All Been Done" and "Pinch Me"?', 'Our Lady Peace', 'Goo Goo Dolls', 'Barenaked Ladies', 'Smash Mouth', 'Barenaked Ladies' ],
  ...
  [ 'easy', 'Who is the only artist to win a Grammy Award for Best New Artist, only to have it later revoked?', 'Dane Hale', 'Chris Brown', 'Puff Daddy', 'Milli Vanilli', 'Milli Vanilli' ],
  ...
  [ 'hard', 'What is Tina Turner\'s real name?', 'Annie Mae Bullock', 'Roberta Streeter', 'Virginia Patterson Hensley', 'Brogan Sykes', 'Annie Mae Bullock' ],
  ...
  [ 'hard', 'What movie featured Madonna\'s hit "I\'ll Remember"?', 'Evita', 'A League Of Their Own', 'Who\'s That Girl', 'With Honors', 'With Honors' ],
  ...
  [ 'hard', 'What is rapper MC Hammer\'s real name?', 'Marvin Lee Aday', 'Hugh Cregg', 'Stanley Burrell', 'Jack Whitis', 'Stanley Burrell' ],
  [ 'hard', 'What was the name of Weird Al Yankovic\'s parody of The Presidents Of The USAs "Lump"?', 'Gump', 'Stump', 'Dump', 'Bump', 'Gump' ],
  ...
  [ 'hard', 'From what country did 1990s alternative band Silverchair hail from?', 'Australia', 'Ireland', 'UK', 'Canada', 'Australia' ],
  ...
  [ 'hard', 'Which Seattle band sang these lyrics in a hit song: "Im diseased, I don\'t mind, I\'ll make you love me til the day you die"?', 'Soundgarden', 'Alice In Chains', 'Pearl Jam', 'Mudhoney', 'Mudhoney' ],
  ...
  [ 'hard', 'What is Fatboy Slim\'s real name?', 'John Jackson', 'Lewis Lea', 'Johnny Corley', 'Norman Cook', 'Norman Cook' ],
  [ 'hard', 'What is U2 guitarist The Edge\'s real name?', 'Dane Hale', 'Paul Hewson', 'Reginald Kenneth Dwight', 'Dave Evans', 'Dave Evans' ],
  ...
  [ 'hard', 'What is Marc Anthony\'s real name?', 'Marco Flores', 'Marco Sanchez', 'Marco Gomez', 'Marco Antonio Muniz', 'Marco Antonio Muniz' ],
  ...
  [ 'hard', 'What is Foxy Brown\'s real name?', 'Regina Bowman', 'Roberta Streeter', 'Inga Marchand', 'Kimberly Jones', 'Inga Marchand' ],
  [ 'hard', 'What is singer Sade\'s real name?', 'Helen Folasade Adu', 'Friday Peterson', 'Eileen Regina Edwards', 'Eliza Brock', 'Helen Folasade Adu' ],
  ...
  [ 'hard', 'What was the name of the cat that appeared in Paula Abdul\'s "Opposites Attract" video?', 'Kit Cat', 'DJ Jazzy Cat', 'Fly Cat', 'MC Skat Cat', 'MC Skat Cat' ],
  [ 'hard', 'What was the name of Motley Crue\'s 1991 greatest hits compilation?', 'Forty Seasons', 'Decade Of Decadence', 'Living After Midnight', 'Vault', 'Decade Of Decadence' ],
  ...
  [ 'hard', 'What is rapper Snoop Dogg\'s real name?', 'Marvin Lee Aday', 'Brandon Lyons', 'Kenneth Edmonds', 'Calvin Broaddus', 'Calvin Broaddus' ],
  ...
  [ 'hard', 'Who played the record label executive Mr. White in the movie "That Thing You Do"?', 'Zach Hendrix', 'Woody Allen', 'Tom Hanks', 'Tom Cruise', 'Tom Hanks' ],
...
country_questions = [
  ...
  [ 'easy', 'Which Bellamy Brothers hit song has these lyrics: "There\'s a reason for the sun shiny sky, And there\'s a reason why Im feelin\' so high"?', 'Let Your Love Flow', 'Satin Sheets', 'Hell Cat', 'Theres A Reason', 'Let Your Love Flow' ],
  ...
  [ 'easy', 'What 1983 duet was a hit for Kenny Rogers and Dolly Parton?', 'Islands In The Stream', 'You Don\'t Bring Me Flowers', 'All I Ever Need Is You', 'Every Time Two Fools Collide', 'Islands In The Stream' ],
  ...
  [ 'easy', 'On John Anderson\'s hit "I\'m Just An Old Chunk Of Coal," what does he hope to become someday?', 'Diamond', 'Sapphire', 'Emerald', 'Ruby', 'Diamond' ],
  ...
  [ 'easy', 'What was the name of Bill Monroe\'s backing band?', 'Savannah Band', 'Tuscon Tools', 'Trinkets', 'Blue Grass Boys', 'Blue Grass Boys' ],
  ...
  [ 'easy', 'Who had a country hit in 2008 with "You\'re Gonna Miss This"?', 'Trace Adkins', 'Tim McGraw', 'Brad Paisley', 'Kenny Chesney', 'Trace Adkins' ],
  [ 'easy', 'How many members are in the band Dixie Chicks?', '4', '2', '5', '3', '3' ],
  [ 'easy', 'What Toby Keith song was a response to the attacks of September 11, 2001?', 'I Don\'t Know Why', 'Have You Forgotten?', 'Courtesy Of The Red, White & Blue', 'The Rising', 'Courtesy Of The Red, White & Blue' ],
  ...
  [ 'easy', 'In which Shania Twain song does she sarcastically proclaim "Ok, so you\'re a rocket scientist" ?', 'Don\'t Be Stupid (You Know I Love You)', 'From This Moment On', 'Man, I Feel Like A Woman', 'That Don\'t Impress Me Much', 'That Don\'t Impress Me Much' ],
  ...
  [ 'hard', 'Which group\'s original name was Wildcountry?', 'The Oak Ridge Boys', 'Sugarland', 'Brooks & Dunn', 'Alabama', 'Alabama' ],
  [ 'hard', 'As part of Johnny Cash\'s "A Boy Named Sue," who wrote the lyrics "Son, this world is rough; And if a mans gonna make it, hes gotta be tough"?', 'Shel Silverstein', 'John Lennon', 'Dylan Thomas', 'Viraj Parikh', 'Shel Silverstein'],
  [ 'hard', 'What was singer Patsy Cline\'s real name?', 'Roberta Streeter', 'Eileen Regina Edwards', 'Kathleen Sears', 'Virginia Patterson Hensley', 'Virginia Patterson Hensley'],
  ...
  [ 'hard', 'Which Marty Robbins hit tells the story of a west Texas cowboy who falls in love with Feleena at a bar?', 'Don\'t Worry', 'El Paso', 'She Was Only Seventeen', 'Big Iron', 'El Paso'],
  ...
  [ 'hard', 'What is Shania Twain\'s real name?', 'Eileen Regina Edwards', 'Kathleen Sears', 'Selena Boz', 'Virginia Patterson Hensley', 'Eileen Regina Edwards'],
  [ 'hard', 'What is Garth Brooks\' real first name?', 'Terrence', 'Trinidad', 'Thomas', 'Troyal', 'Troyal'],
  [ 'hard', 'In Reba McEntire\'s hit "Fancy," she lived on the outskirts of what city?', 'San Francisco', 'New Orleans', 'New York City', 'Tulsa', 'New Orleans'],
    ]
