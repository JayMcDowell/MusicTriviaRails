...
sixties_questions = [
  ...
  [ 'easy', 'What Rolling Stones song has the line: "But it\'s all right now; in fact, it\'s a gas"?', 'Sugar Sugar', 'Whats Going On', 'Wedding Bell Blues', 'Jumpin Jack Flash', 'Jumpin Jack Flash' ],
